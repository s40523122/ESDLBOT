...
class roslaunch_process():
    ...
    def start_navigation(self,mapname):
        ...
        self.process_navigation = subprocess.Popen(["roslaunch","--wait", "my_car", "esdlbot_V1_navigation.launch"])
...
def index():
	...
	return render_template('index.html',title='Index',map = [[0,'library']])
...
def webimage():
	...
	return render_template('webimage.html')
...
def navigation():
	...
	with get_db():
	    try:
	        ...
	        print(e)
	'''
	return render_template('navigation.html',map = [[0, 'library']])
...
def mapping():
	...
	return render_template('mapping.html', title='Mapping', map = [[0, 'library']]) 
